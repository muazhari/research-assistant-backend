...
from apps.outers.interfaces.deliveries.controllers import account_controller, document_process_controller, \
    document_type_controller, file_document_controller, text_document_controller, web_document_controller, \
    document_controller, passage_search_controller, long_form_qa_controller, authorization_controller
...
protected_router.include_router(authorization_controller.router)
