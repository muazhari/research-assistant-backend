...
from app.inners.models.value_objects.contracts.requests.basic_settings.multihop_embedding_model_body import \
    MultihopEmbeddingModelBody
from app.inners.models.value_objects.contracts.requests.basic_settings.online_embedding_model_body import \
    OnlineEmbeddingModelBody
