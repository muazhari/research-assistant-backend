...
@router.post(path="/text", response_model=DocumentSearchResponse)
async def passage_search_text(request: DocumentSearchRequest) -> DocumentSearchResponse:
...
@router.post(path="/web", response_model=DocumentSearchResponse)
async def passage_search_web(request: DocumentSearchRequest) -> DocumentSearchResponse:
    time_start = datetime.now()
...
@router.post(path="/file", response_model=DocumentSearchResponse)
async def passage_search_file(request: DocumentSearchRequest) -> DocumentSearchResponse:
    time_start = datetime.now()
